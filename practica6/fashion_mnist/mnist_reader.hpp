 ...
 * The dataset is assumed to be in a mnist subfolder
 *
 * \param training_limit The maximum number of elements to read from training set (-1, don't load, 0: no limit)
 * \param test_limit The maximum number of elements to read from test set (-1, don't load, 0: no limit)
 * \return The dataset
 */
template <template <typename...> class Container, typename Image, typename Label = uint8_t>
MNIST_dataset<Container, Image, Label> read_dataset_3d(int training_limit = 0, int test_limit = 0) {
 ...
 */
template <template <typename...> class Container, typename Image, typename Label = uint8_t>
MNIST_dataset<Container, Image, Label> read_dataset_direct(const std::string& folder, int training_limit = 0, int test_limit = 0) {
    MNIST_dataset<Container, Image, Label> dataset;
 ...
 */
template <template <typename...> class Container, typename Image, typename Label = uint8_t>
MNIST_dataset<Container, Image, Label> read_dataset_direct(int training_limit = 0, int test_limit = 0) {
...
MNIST_dataset<Container, Sub<Pixel>, Label> read_dataset(int training_limit = 0, int test_limit = 0) {
 ...
 */
template <template <typename...> class Container = std::vector, template <typename...> class Sub = std::vector, typename Pixel = uint8_t, typename Label = uint8_t>
MNIST_dataset<Container, Sub<Pixel>, Label> read_dataset(const std::string& folder, int training_limit = 0, int test_limit = 0) {
